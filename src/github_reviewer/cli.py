...
def review(
    ...
    if show_intermediate:
        ...
        console.print(report.reviewer_output)
        console.rule("Verifier")
        console.print(report.verifier_output)
    console.print(report.final_output, end="")
...
def history(
    ...
    try:
        ...
        commits = repo_tools.commit_history(base_ref, head_ref, limit=limit)
        if not commits:
